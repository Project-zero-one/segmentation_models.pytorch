...
def augment_and_mix(image, mean, std, severity=3, width=3, depth=-1, alpha=1., augall=False):
    ...
    """
    global augmentations_all, augmentations
...
class RandomAugMix(ImageOnlyTransform):
    ...
    def __init__(self, mean=0, std=1, severity=3, width=3, depth=-1, alpha=1., always_apply=False, p=0.5):
